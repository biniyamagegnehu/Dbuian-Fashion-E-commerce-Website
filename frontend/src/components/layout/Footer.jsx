      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">Dbuian Fashion</span>
            </div>
          ...
          >
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-start">
                ...
                <span>support@dbuianfashion.com</span>
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        >
          <p className="text-gray-400 text-sm">
            © {currentYear} Dbuian Fashion. All rights reserved.
          </p>
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            <span className="text-gray-400 text-sm">Exclusive for university students</span>
          </div>
        </motion.div>
      </div>
    </footer>
