  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      const validItems = items
        .map((item) => {
          ...
          if (item.product && typeof item.product === "object") {
            ...
            console.log(
              `📦 Using product object ID: ${productId} for ${item.name}`,
            );
          } else if (item.product && typeof item.product === "string") {
            productId = item.product;
            console.log(
              `📦 Using product string ID: ${productId} for ${item.name}`,
            );
          } else if (item.id) {
            productId = item.id;
            ...
            productId = item.productId;
            console.log(
              `📦 Using item.productId: ${productId} for ${item.name}`,
            );
          }
      ...
      if (validItems.length === 0) {
        ...
        console.log(
          "🔄 Trying alternative approach - fetching fresh cart data...",
        );
        try {
      ...
      if (validItems.length === 0) {
        const errorMsg =
          "No valid products in cart. Please add products to cart and try again.";
            ...
            <div>
              <GlassCard className="p-6 backdrop-blur-xl">
                ...
                <p className="text-gray-400 text-sm mb-6">
                  Please provide your campus delivery details. We'll deliver
                ...
                <div className="mt-6 p-4 bg-cyan-400/10 border border-cyan-400/20 rounded-lg">
                  ...
                  <p className="text-cyan-300 text-sm">
                    We deliver directly to your campus location. Please ensure
                    your block and room numbers are accurate for smooth
                    delivery.
                  </p>
                </div>
                ...
                <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
                  {items.map((item) => (
                    <div
                      ...
                      className="flex justify-between items-start pb-4 border-b border-gray-700/50"
                    >
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-gray-300 mb-6">
                    Are you sure you want to place this order? This action
                    cannot be undone.
                  </p>
                  ...
                  <div className="bg-gray-700/50 rounded-lg p-4 mb-6 text-left">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">
                          Block {formData.blockNumber}, Room{" "}
                          {formData.roomDormNumber}
                        </span>
                      </div>
                      <div className="flex justify-between">
